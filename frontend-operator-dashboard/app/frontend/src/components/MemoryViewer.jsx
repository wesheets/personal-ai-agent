...
const MemoryViewer = () => {
  ...
  return (
    <Box minH="inherit">
      {/* Filter controls */}
      <Box mb={6} p={4} borderWidth="1px" borderRadius="md" bg={bgColor} borderColor={borderColor}>
        ...
        <Button mt={4} colorScheme="blue" variant="outline" size="sm" onClick={resetFilters}>
          Reset Filters
        </Button>
      </Box>
