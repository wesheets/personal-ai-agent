      ...
      switch (activeTab) {
        case 'memory':
          ...
          payload = {
            ...
            tags: formData.memory.tags.split(',').map(tag => tag.trim()).filter(tag => tag)
          };
          break;
        case 'reflection':
    ...
    switch (activeTab) {
      ...
      case 'reflection':
        return (
          <div className="space-y-4">
            <div>
              <label htmlFor="reflection_agent_id" className="block text-sm font-medium text-gray-700 mb-1">
                Agent ID *
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="reflection_type" className="block text-sm font-medium text-gray-700 mb-1">
            ...
            <div>
              <label htmlFor="reflection_limit" className="block text-sm font-medium text-gray-700 mb-1">
                Memory Limit
              </label>
              <input
                type="number"
