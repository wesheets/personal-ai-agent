    ...
    <div className="container mx-auto p-4">
      ...
      <div className="mb-6">
        <p className="text-gray-700">
          This page allows you to validate the cognition + memory loop across all active agents. Run
          the tests to ensure all agents are responding correctly and maintaining memory context.
        </p>
      </div>
