...
import { Box, Flex, VStack, Heading, Text, Icon, Button, useColorModeValue } from '@chakra-ui/react';
      ...
      <VStack spacing={6} align="stretch" p={4}>
        ...
        <Box pt={2} pb={4}>
          <Flex align="center" mb={4}>
            ...
            <Box>
              <Heading as="h1" size="sm">Promethios UI v2</Heading>
              <Text fontSize="xs" opacity="0.8">Agent OS Shell</Text>
            </Box>
          </Flex>
          ...
          {currentUser && (
            <Box p={3} borderRadius="md" bg={useColorModeValue('gray.50', 'gray.700')}>
              ...
              <Text fontSize="sm" opacity="0.8">{currentUser?.email || 'user@example.com'}</Text>
            </Box>
          )}
        </Box>
