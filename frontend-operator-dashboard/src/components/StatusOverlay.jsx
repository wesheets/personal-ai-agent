...
const StatusOverlay = () => {
  ...
  if (!overlayVisible && warnings.length === 0 && systemStatus.type === STATUS_TYPES.STABLE)
    return null;
            ...
            {delegateStatus.errors.length > 0 && (
              ...
              >
                ...
                <Text fontSize="xs" mt={1}>
                  ...
                  {delegateStatus.errors.length > 1 &&
                    ` (+${delegateStatus.errors.length - 1} more)`}
                </Text>
              </Box>
            )}
