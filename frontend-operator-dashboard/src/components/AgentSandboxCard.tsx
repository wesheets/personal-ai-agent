  ...
  return (
    ...
    >
      <VStack align="stretch" spacing={4}>
        ...
        <Text fontSize="xs" color="gray.500">Agent ID: {agentId}</Text>
        ...
        {activeInstruction && (
          <Box>
            <Heading size="sm" mb={2}>Active Instruction</Heading>
            <Box 
              p={3} 
              borderWidth="1px" 
              borderRadius="md" 
            ...
            >
              <VStack align="stretch" spacing={2}>
                ...
                <HStack>
                  <Badge colorScheme={
                    activeInstruction.status === 'complete' ? 'green' : 
                    activeInstruction.status === 'failed' ? 'red' : 
                    activeInstruction.status === 'in_progress' ? 'blue' : 'gray'
                  }>
                ...
                <Box>
                  <Text fontSize="xs" fontWeight="semibold">Required Outputs:</Text>
        ...
        {lastMemory && (
          <Box>
            <Heading size="sm" mb={2}>Last Memory</Heading>
            <Box 
              p={3} 
              borderWidth="1px" 
              borderRadius="md" 
              ...
              bg={useColorModeValue('gray.50', 'gray.700')}
            >
              <Text fontSize="sm" noOfLines={3}>{lastMemory}</Text>
            </Box>
          </Box>
        )}
        ...
        {activeTool && (
          <Box>
            <Heading size="sm" mb={2}>Active Tool</Heading>
        ...
        {toolkit.length > 0 && (
          <Box>
            <Heading size="sm" mb={2}>Toolkit</Heading>
        ...
        {currentReflection && (
          <Box>
            <Heading size="sm" mb={2}>Current Reflection</Heading>
            <Box 
              p={3} 
              borderWidth="1px" 
              borderRadius="md" 
