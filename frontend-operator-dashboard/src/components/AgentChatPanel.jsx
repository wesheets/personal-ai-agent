...
const AgentChatPanel = () => {
    ...
    return (
      <Center h="calc(100vh - 140px)">
        ...
        >
          ...
          <Text>
            The requested agent could not be loaded. Please select a valid agent from the dashboard.
          </Text>
  ...
  return (
    <VStack spacing={4} align="stretch" h="calc(100vh - 140px)">
      ...
      <Flex p={4} borderWidth="1px" borderRadius="lg" borderColor={borderColor} bg={bgColor}>
        <IconButton
          icon={<FiPaperclip />}
