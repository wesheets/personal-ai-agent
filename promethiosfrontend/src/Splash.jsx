  ...
  return (
    <div className="min-h-screen bg-black text-white grid place-items-center px-4">
      <div className="w-full max-w-md space-y-8 text-center animate-fade-in">
        ...
        >
          <h2 className="text-xl font-semibold tracking-wide mb-2">Welcome to Promethios OS</h2>
        ...
        <p className="text-sm text-gray-500 font-mono animate-pulse-slow">🔥 The Fire is Lit</p>
      </div>
    </div>
  );
}
