...
const MemoryAgentView = () => {
  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
      // Check file type
      const validTypes = ['.txt', '.pdf', '.json', 'text/plain', 'application/pdf', 'application/json'];
  ...
  return (
    <Box p={4}>
      <Heading mb={6} size="lg">Memory Agent</Heading>
      ...
      >
        ...
        >
          <CardBody>
            <Heading size="md" mb={4}>Paste Text</Heading>
          ...
          <CardBody>
            ...
            <VStack spacing={4} align="stretch">
              ...
              >
                ...
                <Text fontSize="sm" color="gray.500">Supports TXT, PDF, and JSON files</Text>
