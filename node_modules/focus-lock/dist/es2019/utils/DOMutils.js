 ...
 */
export const filterFocusable = (nodes, visibilityCache) =>
  toArray(nodes)
    .filter((node) => isVisibleCached(visibilityCache, node))
    .filter((node) => notHiddenInput(node));
export const filterAutoFocusable = (nodes, cache = new Map()) =>
 ...
 */
export const getTabbableNodes = (topNodes, visibilityCache, withGuards) =>
 ...
 * @param visibilityCache - an cache to store intermediate measurements. Expected to be a fresh `new Map` on every call
 */
export const getFocusableNodes = (topNodes, visibilityCache) =>
 ...
 * @param visibilityCache
 */
export const parentAutofocusables = (topNode, visibilityCache) =>
