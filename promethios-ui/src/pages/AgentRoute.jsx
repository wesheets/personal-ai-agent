...
const validAgentIds = [
  'core-forge', 'LifeTree', 'SiteGen', 'NEUREAL', 
  'ReflectionAgent', 'CADBuilderAgent', 'DreamAgent',
  'hal9000', 'ash-xenomorph', 'OpsAgent', 'ObserverAgent', 'MemoryAgent'
];
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (data.agents && Array.isArray(data.agents)) {
            ...
            const agentExists = data.agents.some(agent => 
