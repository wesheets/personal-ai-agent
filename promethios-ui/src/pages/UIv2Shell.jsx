...
const UIv2Shell = ({ activePage }) => {
  ...
  return <AppLayout activePage={activePage}>{renderContent()}</AppLayout>;
};
        ...
        >
          ...
          <VStack align="stretch" spacing={4}>
            <HStack p={3} bg={useColorModeValue('blue.50', 'blue.900')} borderRadius="md">
              ...
              <Button size="sm" colorScheme="blue" onClick={() => handleAgentChat('hal9000')}>
                Chat
              </Button>
            </HStack>
            <HStack p={3} bg={useColorModeValue('purple.50', 'purple.900')} borderRadius="md">
              ...
              <Button
                size="sm"
                colorScheme="purple"
                onClick={() => handleAgentChat('ash-xenomorph')}
              >
                Chat
              </Button>
            </HStack>
  ...
  return (
    <VStack spacing={4} align="stretch" h="calc(100vh - 140px)">
      ...
      <Flex
        ...
        bg={useColorModeValue('white', 'gray.800')}
      >
        <IconButton icon={<FiPaperclip />} aria-label="Attach file" variant="ghost" mr={2} />
        <Input
          flex="1"
          mr={2}
  ...
  if (!agentData) {
    return (
      <Box textAlign="center" py={10} px={6}>
        <Box display="inline-block" bg="red.500" rounded="full" color="white" p={3} mb={4}>
          !
        </Box>
        <Heading as="h2" size="lg" mb={2}>
          Agent Not Found
        </Heading>
        <Text mb={6}>We couldn't find details for this agent. Please select a valid agent.</Text>
    ...
    switch (id) {
      case 'hal9000':
        return {
          ...
          color: 'blue',
          description:
            'HAL is an advanced AI system designed to assist with a wide range of tasks and provide information on various topics.',
          capabilities: [
      ...
      case 'ash-xenomorph':
        return {
          ...
          color: 'purple',
          description:
            'ASH is a specialized AI focused on scientific analysis and research assistance.',
          capabilities: [
            'Scientific research',
            'Data visualization',
            'Pattern recognition',
