          ...
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-lg border border-blue-200">
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <span
                  className={`font-medium ${metrics.status === 'healthy' ? 'text-green-600' : 'text-red-600'}`}
                >
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-4 rounded-lg border border-purple-200">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span
                  className={`font-medium ${(metrics.error_rate || 0) > 5 ? 'text-red-600' : 'text-green-600'}`}
                >
          ...
          <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 p-4 rounded-lg border border-yellow-200">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span
                  className={`font-medium ${(metrics.api_success_rate || 0) < 95 ? 'text-red-600' : 'text-green-600'}`}
                >
              ...
              <div className="flex justify-between">
                ...
                <span
                  className={`font-medium ${(metrics.server_errors || 0) > 0 ? 'text-red-600' : 'text-green-600'}`}
                >
