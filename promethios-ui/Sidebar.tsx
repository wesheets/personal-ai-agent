        ...
        <Box overflowY="auto" flex="1" p={2}>
          <Accordion defaultIndex={[0, 1]} allowMultiple>
            ...
            <AccordionItem border="none">
              <AccordionButton py={2} px={1}>
                <HStack flex="1" textAlign="left">
                  <Text fontWeight="medium" fontSize="16px">🧠 SYSTEM</Text>
                </HStack>
                <AccordionIcon />
              </AccordionButton>
            ...
            <AccordionItem border="none">
              <AccordionButton py={2} px={1}>
                <HStack flex="1" textAlign="left">
                  <Text fontWeight="medium" fontSize="16px">👤 AGENTS</Text>
                </HStack>
                <AccordionIcon />
              </AccordionButton>
              <AccordionPanel pb={4} pt={0} px={1}>
                <VStack align="stretch" spacing={1}>
                  {agents.filter(agent => agent.id !== 'orchestrator').map(agent => (
                    <Box
                      key={agent.id}
                      p={2}
                      borderRadius="6px" // 6px radius as specified
            ...
            <AccordionItem border="none">
              <AccordionButton py={2} px={1}>
                <HStack flex="1" textAlign="left">
                  <Text fontWeight="medium" fontSize="16px">📌 Goals / Threads</Text>
                </HStack>
                <AccordionIcon />
              </AccordionButton>
              <AccordionPanel pb={4} pt={0} px={1}>
                <VStack align="stretch" spacing={1}>
                  {threads.map(thread => (
                    ...
                    >
                      <Text fontSize="16px" fontWeight="medium">{thread.title}</Text>
            ...
            <AccordionItem border="none">
              <AccordionButton py={2} px={1}>
                <HStack flex="1" textAlign="left">
                  <Text fontWeight="medium" fontSize="16px">🧰 Tools</Text>
                </HStack>
                <AccordionIcon />
              </AccordionButton>
              <AccordionPanel pb={4} pt={0} px={1}>
            ...
            <AccordionItem border="none">
              <AccordionButton py={2} px={1}>
                <HStack flex="1" textAlign="left">
                  <Text fontWeight="medium" fontSize="16px">⏳ Checkpoints</Text>
                </HStack>
                <AccordionIcon />
              </AccordionButton>
              <AccordionPanel pb={4} pt={0} px={1}>
                  ...
                  {checkpoints.map(checkpoint => (
                    ...
                    >
                      ...
                      <Badge 
                        size="sm" 
                        colorScheme={
                          checkpoint.status === 'approved' ? 'green' : 
                          checkpoint.status === 'active' ? 'blue' : 'yellow'
                        }
                      >
                        {checkpoint.status}
                      </Badge>
            ...
            <AccordionItem border="none">
              <AccordionButton py={2} px={1}>
                <HStack flex="1" textAlign="left">
                  <Text fontWeight="medium" fontSize="16px">🗄 Archives</Text>
                </HStack>
                <AccordionIcon />
              </AccordionButton>
              <AccordionPanel pb={4} pt={0} px={1}>
            ...
            <AccordionItem border="none">
              <AccordionButton py={2} px={1}>
                <HStack flex="1" textAlign="left">
                  <Text fontWeight="medium" fontSize="16px">⚙️ Settings</Text>
                </HStack>
                <AccordionIcon />
              </AccordionButton>
              <AccordionPanel pb={4} pt={0} px={1}>
            ...
            <AccordionItem border="none">
              <AccordionButton py={2} px={1}>
                <HStack flex="1" textAlign="left">
                  <Text fontWeight="medium" fontSize="16px">🆘 Help</Text>
                </HStack>
                <AccordionIcon />
              </AccordionButton>
              <AccordionPanel pb={4} pt={0} px={1}>
