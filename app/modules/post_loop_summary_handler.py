...
async def call_run_critic(loop_id: str) -> Dict[str, Any]:
...
async def call_pessimist_check(loop_id: str) -> Dict[str, Any]:
...
async def call_ceo_review(loop_id: str) -> Dict[str, Any]:
...
async def call_drift_summary(loop_id: str) -> Dict[str, Any]:
